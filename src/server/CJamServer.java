...
public class CJamServer extends PApplet {
    ...
    public static void setFolders () {
        ...
        setupFilesPath = mainPath + File.separator + "setupFiles" + File.separator;
        innerClassPath = mainPath + File.separator + "innerClasses" + File.separator;
        mainCanvasTxt = new File( setupFilesPath + "mainCanvas.txt" );
        mainCanvasJava = new File( mainPath + File.separator + "src" + File.separator + "server" + File.separator + "MainCanvas.java" );
    }
    ...
    private void startMC () {
        ...
        File f1 = new File( mainPath + File.separator + "src"+File.separator+"server"+File.separator+"MainCanvas.java");
        File f2 = new File( mainPath + File.separator + "src"+File.separator+"server"+File.separator+"MainCanvasAdd.java" );
